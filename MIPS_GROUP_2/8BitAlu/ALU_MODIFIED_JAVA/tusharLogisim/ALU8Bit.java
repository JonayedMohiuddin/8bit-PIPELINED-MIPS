...
public class ALU8Bit extends ManagedComponent
{
    ...
    private static class Factory extends AbstractComponentFactory {
        private Factory() { }
        public String getName() { return "ALU-8 by ART"; }
        public String getDisplayName() { return "ALU-8 by ART"; }
    ...
    public ALU8Bit(Location loc, AttributeSet attrs) {
        super(loc, attrs, 5);
        setEnd(0, loc.translate(-30, -30), BITWIDTH_8, 1);
        setEnd(1, loc.translate(-30, 30), BITWIDTH_8, 1);
        setEnd(2, loc.translate(-10, 40), BITWIDTH_3, 1);
        setEnd(3, loc.translate(30, -20), BITWIDTH_1, 2);
        setEnd(4, loc.translate(30, 0), BITWIDTH_8, 2);
    ...
    public void propagate(CircuitState state) {
        ...
        Value out = Value.createKnown(BITWIDTH_8, ans);
